...
export const projects: ProjectCard[] = [
  {
    id: 'revit',
    platform: 'Revit',
    title: 'Add-in: виды модуля на лист и цепи размеров',
    description:
      'Комплект чертежей модульного элемента: виды спереди / сбоку / сверху / изометрия на лист A4…A0. Шаблоны, автомасштаб, ориентация. Цепи размеров по именованным плоскостям семейства.',
    bullets: [
      'Выбор модулей → листы 2×2 под шаблоны видов',
      'Формат листа, масштаб и ориентация проекций',
      'Цепи: оболочка, закладные, профили и др. по канону плоскостей',
    ],
    tags: ['Revit API', 'C#', '.NET', '2021 / 2022'],
  },
  {
    id: 'kmd',
    platform: 'КОМПАС-3D',
