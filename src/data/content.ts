...
export const projects: ProjectCard[] = [
  {
    ...
    bullets: [
      'Выбор модулей → создание 3х основных видов + 1 изометрия по шаблону',
      'Формат листа, масштаб и ориентация проекций',
      'Цепи: оболочка, закладные, профили и др. по канону плоскостей',
    ],
    caseStudy: {
      problem:
        'Ручная сборка видов и размеров для модульных элементов занимала много времени и давала разный результат у разных исполнителей.',
      approach:
        'Сделал add-in, который формирует комплект видов на лист, применяет шаблоны, подбирает масштаб и строит цепи размеров по именованным плоскостям.',
      constraints:
        'Поддержка Revit 2021/2022, разные семейства и внутренние стандарты именования в проектных командах.',
      result:
        'Комплект формируется в повторяемом формате; сокращается ручная рутина и повышается стабильность выпуска.',
    },
  ...
  },
  {
    ...
    caseStudy: {
      problem:
        'Параметрические сборки и обмен геометрией между отделами были фрагментированы и зависели от ручных действий конструктора.',
      approach:
        'Сделал инструменты на SolidWorks API для конфигураций, пакетных операций и контролируемого экспорта в производственную цепочку.',
      constraints:
        'Разные правила оформления и требования к выходным форматам в зависимости от участка и стадии проекта.',
      result:
        'Передача геометрии и подготовка данных стали более стабильными, с меньшим числом ручных исправлений.',
    },
